    ...
    render() {
        return (
            <Fragment>
                ...
                <MetisMenu content={NewNav} activeLinkFromLocation className="vertical-nav-menu" iconNamePrefix="" classNameStateIcon="pe-7s-angle-down"/>
            </Fragment>
        );
    }
